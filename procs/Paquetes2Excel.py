...
def p02xlsx():
    try:
        ...
        writer = pd.ExcelWriter(
            archivo, engine="xlsxwriter"
        )  # pylint: disable=abstract-class-instantiated

        # Anexamos paginar por pagina en el mismo excel
        df.to_excel(writer, sheet_name="1252 envio")
        ...
        console.log(f"{archivo} exitosamente creado.")
        input("[Presione ENTER para continuar.]")
    except Exception as e:
        console.log(f"Hubo un error generando el excel:\n{str(e)}")
        input("[Presione ENTER para continuar.]")
...
def p12xlsx():
    try:
        ...
        print(df)
        df.to_excel(r"out/Paquete1.xlsx", index=False)
        shutil.move(file_name[0], f"in/{file_name[0]}")
        input("[Presione ENTER para continuar.]")
    except Exception as e:
        console.log(f"Hubo un error generando el excel:\n{str(e)}")
...
def p52xlsx():
    try:
        ...
        # Anexamos paginar por pagina en el mismo excel
        df02.to_excel(writer, sheet_name="Info altas")
        df03.to_excel(writer, sheet_name="Categorizados")
        df04.to_excel(writer, sheet_name="Alta coop")
        df05.to_excel(writer, sheet_name="Alta asoc-coop")
...
def p72xlsx():
    try:
        ...
        df.to_excel(r"out/p7.xlsx", index=False)
        shutil.move(file_name[0], f"in/{file_name[0]}")
        console.log(f"p7.xlsx exitosamente creado.")
        input("[Presione ENTER para continuar.]")
    except Exception as e:
        console.log(f"Hubo un error generando el excel:\n{str(e)}")
        input("[Presione ENTER para continuar.]")
...
def p82xlsx():
    ...
    try:
        ...
        # Anexamos paginar por pagina en el mismo excel
        df02.to_excel(writer, sheet_name="Modificaciones")
        df03.to_excel(writer, sheet_name="Bajas")
        ...
        console.log(f"p8.xlsx exitosamente creado.")
        input("[Presione ENTER para continuar.]")
    except Exception as e:
        console.log(f"Hubo un error generando el excel:\n{str(e)}")
        input("[Presione ENTER para continuar.]")
...
def somoso2xlsx():
    try:
        ...
        df.to_excel(r"out/SOMOSO.xlsx", index=False)
        shutil.copy(file_name[0], f"in/{file_name[0]}")
        console.log(f"SOMOSO.xlsx exitosamente creado.")
        input("[Presione ENTER para continuar.]")
    except Exception as e:
        console.log(f"Hubo un error generando el excel:\n{str(e)}")
        input("[Presione ENTER para continuar.]")
